...
function Home() {
  ...
  return (
    ...
    <div className='md:pl-40 md:pt-20 pl-5 pt-5'>
      ...
      <div className=' flex  items-center text-2xl flex-nowrap gap-4 pt-6' ><h3 className='text-sm'>follow me on</h3>
        <button><FaGithub onClick={() => (window.location.href = 'https://github.com/mauryamj')} className='text-3xl'/></button>
        <button><FaLinkedin onClick={() => (window.location.href = 'https://www.linkedin.com/in/mauryamj')}className='text-3xl'/></button>
        <button><FaThreads onClick={() => (window.location.href = 'https://www.threads.com/@mauryamj_')}className='text-3xl'/></button></div>
      <div className='pt-6 flex  items-center'>
        <div><button className='rounded-md bg-gray-900 text-white p-2'
        onClick={
          ()=> 
        ...
        <div className='pl-5'><button className='rounded-md bg-white text-black p-2 border border-black' onClick={handleDownload}>Download Resume</button></div>
      </div>
      <div className='pt-5'>
        <h6>Quick Stats:</h6>
    ...
    <img src='/logo.svg' className='pl-10 pr-40 hidden md:block '/>
    </div>
    </>
  )
}
