  ...
  Future<void> _sendEmail() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Could not launch email app. Please check your email client.')),
      );
    }
  }
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              SizedBox(width: 10),
                                              IconButton(onPressed: () {_launchUrl('https://github.com/mauryamj');},
                                                  icon: Icon(FontAwesomeIcons.github
                                                      , size: 25)),
                                              SizedBox(width: 10),
                                              IconButton(onPressed: () {_launchUrl('https://www.instagram.com/mauryamj_?igsh=ZWhuMjU3dnNhOGVk');},
                                                  icon: Icon(
                                                      FontAwesomeIcons.instagram
                                                      , size: 25)),
                                              SizedBox(width: 10),
                                              IconButton(onPressed: () {_launchUrl('https://wa.me/qr/CMXCUU4ZL5OON1');},
                                                  icon: Icon(FontAwesomeIcons.whatsapp
                                                      , size: 25)),
                                              SizedBox(width: 10),
                                              IconButton(onPressed: () { _launchUrl('https://www.linkedin.com/in/abhishek-maurya-84588b237/');},
        ...
        return Column(
          children: [
            ...
            Center(
                ...
                children: [
                  ...
                  Row(
                      ...
                      child: Row(
                        children: [
                          for (int i = 0; i < lang['icon'].length; i++)
                            LangBox(icon: lang['icon'][i], name: lang['name'][i]),
                        ],
                      ),
                    ),
                    const SizedBox(height: 20),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          for (int i = 0; i < projectData['name'].length; i++)
                            ProjectBox(
                              i: i,
                            ),
                        ],
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          for (int i = 0; i < addOnsData['Icon'].length; i++)
                            AddOns(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                      width: double.infinity
                                      ,
                                      child: OutlinedButton(onPressed: _sendEmail,
                                        style: ButtonStyle(
              ...
              Container(height: 40, width: double.infinity,color: Colors.black,child: Align(alignment: Alignment.centerLeft,child: Text('© 2025 Created by Abhishek Maurya. All rights reserved.')),)
            ],
          ),
